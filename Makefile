...
NETWORK_ARGS := --rpc-url http://localhost:8545 --private-key $(ANVIL_DEFAULT_KEY) --broadcast

ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(RPC_URL_SEPOLIA) --private-key $(MY_SEPOLIA_METAMASK_PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
